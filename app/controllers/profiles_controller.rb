class ProfilesController < ApplicationController
  ...
  private
    def check_profile_presence
      ...
      redirect_to profile_path(user_profile.id) if user_profile
    end
    ...
    def profile_params
      params.require(:profile).permit(:user_id, :first_name, :last_name, :address, :suburb, :postcode, :state, :buyer, :seller)
    end
end
